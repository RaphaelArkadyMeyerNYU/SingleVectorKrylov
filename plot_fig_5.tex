...
\addseries{#2}{cb_d}{svk}{No Noise}{20}{1}
\addseries{#2}{cb_e}{d1e-14}{\(10^{-14}\) Noise}{20}{1}
\addseries{#2}{cb_h}{d1e-10}{\(10^{-10}\) Noise}{20}{1}
\addseries{#2}{cb_f}{d1e-6}{\(10^{-6}\) Noise}{20}{1}
...
\begin{document}
\makeLpPlot{Impact of Noise on Convergence under Repeated Singular Values}{./exports/plot_perturb_data_d1000_k50_r20_trials10__2023-04-27-18-28.csv}
\end{document}
